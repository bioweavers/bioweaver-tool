...
with st.spinner("Loading data..."):
    ...
    # File in the file path should be named as follows: "cnps.csv".
    cnps_path = Path(__file__).parent.parent / "data" / "cnps.csv"
    ...
    # Folder in the file path should be named as follows: "cnddb" / "cnddb.shp".
    cnddb_path = Path(__file__).parent.parent / "data" / "cnddb" / "cnddb.shp"
